...
public abstract class GLTexture extends BindableGLObject {
	...
	public static GLTexture getTexture(int id) {
		GLTexture tex = Texture1D.get(id);
		if (tex != null)
			return tex;
