...
public class Texture {
	...
	public static String[] status() {
		GL.flushErrors();
		Texture2D texture1d = Texture2D.get(Context.intValue(GL11.GL_TEXTURE_BINDING_1D));
		...
		Texture2D texture2darr = Texture2D.get(Context.intValue(GL30.GL_TEXTURE_BINDING_2D_ARRAY));
		Texture2D texture3d = Texture2D.get(Context.intValue(GL12.GL_TEXTURE_BINDING_3D));
